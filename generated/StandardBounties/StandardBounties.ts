...
export class StandardBounties__getBountyResultValue0Struct extends ethereum.Tuple {
  ...
  get fulfillments(): Array<
    StandardBounties__getBountyResultValue0FulfillmentsStruct
  > {
  ...
  get contributions(): Array<
    StandardBounties__getBountyResultValue0ContributionsStruct
  > {
...
export class StandardBounties__getBountyResultValue0FulfillmentsStruct extends ethereum.Tuple {
...
export class StandardBounties__getBountyResultValue0ContributionsStruct extends ethereum.Tuple {
...
export class StandardBounties extends ethereum.SmartContract {
  ...
  try_bounties(
    param0: BigInt
  ): ethereum.CallResult<StandardBounties__bountiesResult> {
  ...
  getBounty(_bountyId: BigInt): StandardBounties__getBountyResultValue0Struct {
    ...
    return changetype<StandardBounties__getBountyResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getBounty(
    _bountyId: BigInt
  ): ethereum.CallResult<StandardBounties__getBountyResultValue0Struct> {
    let result = super.tryCall(
      "getBounty",
      "getBounty(uint256):((address[],address[],uint256,address,uint256,uint256,bool,(address[],address)[],(address,uint256,bool)[]))",
      [ethereum.Value.fromUnsignedBigInt(_bountyId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<StandardBounties__getBountyResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
